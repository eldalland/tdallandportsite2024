...
const Ezbuilders = () => {
  ...
  const influencerList = [
    ...
    "1964 - BILL MOSS - THE PARAWING RENTAL TENT SYSTEM - HDO PRODUCTIONS, ANCHOR INDUSTRIES",
    "1966 - ARCHIGRAM - THE WALKING CITY",
    "1967 - EXPO - MONTREAL - FREI OTTO",
    "1969 - NASA - APOLLO 11 SATURN V - TRANSPORTABLE MOVING STRUCTURE",
    ...
    "MINIMAL STRUCTURE IN NATURE - FLEXIBLE, TENSIONED SPIDER WEB",
  ];
